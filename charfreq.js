 ...
 * of each letter letter in thatt text, and displays a histogram of the most
...
class Histogram {
    ...
    add(text) {
	// Remove whietspace from the text, and convert to upper case
...
// chunks to the histogram. When it reaches the end of the stream, it
